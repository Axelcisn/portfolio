    ...
    (it) =>
      (mapResult
        ...
        : {
            ...
            name: it.name || it.longname || it.longName || it.description || "",
            exchange: it.exchange || it.exch || it.exchDisp || it.fullExchangeName || "",
            currency: it.currency || "USD",
            type: it.type || it.quoteType || it.typeDisp || "EQUITY",
            raw: it,
          }),
    [mapResult]
  );
