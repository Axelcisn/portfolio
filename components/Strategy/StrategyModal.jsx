...
export default function StrategyModal({
  ...
  // instantiate legs (fixed roles & qty; K/premium null)
      ...
      <div className="modal">
        ...
        <div className="chart-card card">
          <Chart
            ...
            /* If your Chart supports a flag to hide its own editor, pass showControls={false} here */
          />
        </div>

        {/* Metrics strip below chart is embedded in Chart component */}
        ...
        <div className="config card">
          ...
          {/* Footer net premium (mirrors the table’s live total) */}
