...
function shouldUseMock() {
  // Use mock in production when IBKR is not available
  if (process.env.NODE_ENV === 'production' && process.env.USE_MOCK_OPTIONS === 'true') {
    return true;
  }
  // Use mock in development if explicitly enabled
  if (process.env.USE_MOCK_OPTIONS === 'true') {
    return true;
  }
  return false;
}
