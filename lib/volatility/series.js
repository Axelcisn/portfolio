...
/**
 * NOTE (centralization guardrail):
 *   Black–Scholes, normal/lognormal, PoP, EP/EL, and payoff formulas are centralized in:
 *     • lib/quant/formulas.js   (re-exported via lib/quant/index.js)
 *   This file intentionally contains only time-series utilities (price cleaning, returns, realized σ).
 *   Do not add pricing/Greeks/option probability math here—import from the hub instead.
 */
